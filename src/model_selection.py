...
def get_models(random_state=42, imbalance_strategy=True, pos_weight_ratio=None):
    models = {
        "Logistic Regression": LogisticRegression(
            max_iter=1000,
            class_weight='balanced' if imbalance_strategy else None,
        ...
        "Gradient Boosting": GradientBoostingClassifier(random_state=random_state),  # No class_weight
        "Extra Trees": ExtraTreesClassifier(random_state=random_state),  # No class_weight
        ...
        "XGBoost": XGBClassifier(
            eval_metric='logloss',
            scale_pos_weight=pos_weight_ratio if (imbalance_strategy and pos_weight_ratio is not None) else 1,
        ...
        "CatBoost": CatBoostClassifier(
            verbose=0,
            auto_class_weights='Balanced' if imbalance_strategy else None,
            random_state=random_state
        ),
        "SVC": SVC(
            probability=True,
